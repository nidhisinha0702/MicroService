 ...
 */
package codewithnidhi.microservices.notification.order;
...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7516787513538697787L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"codewithnidhi.microservices.notification.order\",\"fields\":[{\"name\":\"orderNumber\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"}]}");
   ...
   */
  public static codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder newBuilder() {
    return new codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder newBuilder(codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder();
    } else {
      return new codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder newBuilder(codewithnidhi.microservices.notification.order.OrderPlacedEvent other) {
    if (other == null) {
      return new codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder();
    } else {
      return new codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(codewithnidhi.microservices.notification.order.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder setOrderNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder clearOrderNumber() {
      orderNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public codewithnidhi.microservices.notification.order.OrderPlacedEvent.Builder clearLastName() {
      lastName = null;
